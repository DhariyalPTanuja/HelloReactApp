...
class Home extends React.Component {
  ...
  // }
  clicking = (event) => {
    console.log("New page button is clicked");
      ...
      <div className='App'>
        <div className='AppOuter'>
          ...
          <div className='content'>
            ...
            <p>i.e. Employbility to all. </p>
            <button onClick={this.clicking}> ClickNew</button>
            <button onClick={this.clickNextPage}>ClickNext</button>
          </div>
